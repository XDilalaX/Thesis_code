...
#jester_dataset_full_subset <- jester_dataset_full[, 2:101]
#jester_dataset_full_subset <- jester_dataset_full[2:51, 2:51]
...
#jester_dataset_full_sample <- complete.cases(jester_dataset_full_change[jester_dataset_full_change != 99])
...
jester_dataset_full_subset <- sample(jester_dataset_full_sample, size=5000, replace = FALSE)
